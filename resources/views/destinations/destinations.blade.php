                ...
                <div class="destinations_container item_grid">
                    ...
                    <div class="destination item">
                        <div class="destination_image">
                            <img src="{{Illuminate\Support\Facades\Storage::url("destination_1.jpg")}}" alt="">
                    ...
                    <div class="destination item">
                        <div class="destination_image">
                            <img src="{{Illuminate\Support\Facades\Storage::url("destination_2.jpg")}}" alt="">
                        </div>
                        <div class="destination_content">
                    ...
                    <div class="destination item">
                        <div class="destination_image">
                            <img src="{{Illuminate\Support\Facades\Storage::url("destination_3.jpg")}}" alt="">
                        </div>
                        <div class="destination_content">
                    ...
                    <div class="destination item">
                        <div class="destination_image">
                            <img src="{{Illuminate\Support\Facades\Storage::url("destination_4.jpg")}}" alt="">
                        </div>
                        <div class="destination_content">
                    ...
                    <div class="destination item">
                        <div class="destination_image">
                            <img src="{{Illuminate\Support\Facades\Storage::url("destination_5.jpg")}}" alt="">
                        </div>
                        <div class="destination_content">
                    ...
                    <div class="destination item">
                        <div class="destination_image">
                            <img src="{{Illuminate\Support\Facades\Storage::url("destination_6.jpg")}}" alt="">
                        </div>
                        <div class="destination_content">
                    ...
                    <div class="destination item">
                        <div class="destination_image">
                            <img src="{{Illuminate\Support\Facades\Storage::url("destination_7.jpg")}}" alt="">
                        </div>
                        <div class="destination_content">
                            <div class="destination_title"><a href="#">Paris</a></div>
                            <div class="destination_subtitle"><p>Nulla pretium tincidunt felis, nec.</p></div>
                    ...
                    <div class="destination item">
                        <div class="destination_image">
                            <img src="{{Illuminate\Support\Facades\Storage::url("destination_8.jpg")}}" alt="">
                        </div>
                        <div class="destination_content">
                            <div class="destination_title"><a href="#">Phi Phi Island</a></div>
                            <div class="destination_subtitle"><p>Nulla pretium tincidunt felis, nec.</p></div>
                    ...
                    <div class="destination item">
                        <div class="destination_image">
                            <img src="{{Illuminate\Support\Facades\Storage::url("destination_9.jpg")}}" alt="">
                        </div>
                        <div class="destination_content">
                            <div class="destination_title"><a href="#">Mykonos</a></div>
                            <div class="destination_subtitle"><p>Nulla pretium tincidunt felis, nec.</p></div>
